...
filter{
  yara {
    ...
    pyyara_py => '/usr/lib/redborder/tools/pyyara.py'
    yara_weights => '/usr/share/logstash/yara_loader.yml'
    ...
    weights => '/usr/share/logstash/weights.yml'
  }
}
----
...
* Value type is `String`.
* Default value is `"/usr/lib/redborder/tools/pyyara.py"`
...
* Value type is `String`.
* Default value is `"/usr/share/logstash/yara_loader.yml"`
...
* Value type is `String`.
* Default value is `"/usr/bin/python3"`

Path of the python version.
...
* Value type is `String`.
* Default value is `"/usr/share/logstash/weights.yml"`
